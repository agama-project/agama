...
systemctl restart agama.service agama-web-server-remote.service
less /var/log/YaST2/y2log
journalctl -u agama-web-server-remote.service
journalctl -u agama.service
systemctl status agama-web-server-remote.service
