...
describe Agama::Storage::ConfigConversions::FromJSONConversions::PartitionSearch do
  ...
  describe "#convert" do
    ...
    include_examples "a search converter supporting the partition number condition"
    include_examples "a search converter supporting the partition id condition"
    ...
    include_examples "a search converter supporting the partition number sort criterion"

    context "with conditions of other kinds of devices" do
      let(:unsupported_conditions) do
        [{ driver: "ahci" }, { transport: "usb" }, { partitions: "any" }]
      end

      include_examples "a search converter rejecting conditions of other devices"
    end

    context "if an 'or' operator over partition numbers is specified" do
      let(:condition) do
