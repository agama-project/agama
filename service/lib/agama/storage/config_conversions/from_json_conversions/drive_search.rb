  ...
  module Storage
    module ConfigConversions
      module FromJSONConversions
        # Drive search conversion from JSON hash according to schema.
        class DriveSearch < DeviceSearch
        private
          ...
          # @see DeviceSearch
          # @return [SearchConditions::Drive]
          def condition_converter
            @condition_converter ||= SearchConditions::Drive.new
          end
