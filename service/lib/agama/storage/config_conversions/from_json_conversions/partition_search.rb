  ...
  module Storage
    module ConfigConversions
      module FromJSONConversions
        # Partition search conversion from JSON hash according to schema.
        class PartitionSearch < DeviceSearch
        private
          ...
          # @see DeviceSearch
          # @return [SearchConditions::Partition]
          def condition_converter
            @condition_converter ||= SearchConditions::Partition.new
          end
