  ...
  module Storage
    module ConfigConversions
      module FromJSONConversions
        # Logical volume search conversion from JSON hash according to schema.
        class LogicalVolumeSearch < DeviceSearch
        private
          ...
          # @see DeviceSearch
          # @return [SearchConditions::LogicalVolume]
          def condition_converter
            @condition_converter ||= SearchConditions::LogicalVolume.new
          end
