...
Go to the [weblate-update-pot.yml](https://github.com/openSUSE/agama/actions/workflows/weblate-update-pot.yml)
...
The Weblate components use the [msgmerge](https://docs.weblate.org/en/weblate-4.9.1/admin/addons.html#addon-weblate-gettext-msgmerge)
...
the [plural forms](https://www.gnu.org/software/gettext/manual/html_node/Plural-forms.html) in the
...
_Note: You cannot use HTML tags in the translated texts, React automatically
escapes all special HTML characters like `<>&`. That is different to YaST
where we can use HTML tags in rich text messages._
