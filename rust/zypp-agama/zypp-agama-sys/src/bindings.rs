...
unsafe extern "C" {
    ...
    #[doc = " check if package is available\n @param zypp see \\ref init_target\n @param tag package name, provides or file path\n @param[out] status (will overwrite existing contents)\n @return true if package is available. In case of error it fills status and return value is undefined"]
    pub fn is_package_available(
        zypp: *mut Zypp,
        tag: *const ::std::os::raw::c_char,
        status: *mut Status,
    ) -> bool;
    #[doc = " check if package is selected for installation\n @param zypp see \\ref init_target\n @param tag package name, provides or file path\n @param[out] status (will overwrite existing contents)\n @return true if package is selected. In case of error it fills status and return value is undefined"]
