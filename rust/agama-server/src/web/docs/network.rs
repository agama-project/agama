...
impl ApiDocBuilder for NetworkApiDocBuilder {
    ...
    fn components(&self) -> Components {
        ComponentsBuilder::new()
            ...
            .schema_from::<crate::network::model::Dhcp4Settings>()
            .schema_from::<crate::network::model::DhcpClientId>()
            .schema_from::<crate::network::model::DhcpIaid>()
            .schema_from::<crate::network::model::Dhcp6Settings>()
            .schema_from::<crate::network::model::DhcpDuid>()
