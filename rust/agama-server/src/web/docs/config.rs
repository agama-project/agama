...
impl ApiDocBuilder for ConfigApiDocBuilder {
    ...
    fn components(&self) -> Components {
        ComponentsBuilder::new()
            ...
            .schema_from::<agama_network::model::BondConfig>()
            .schema_from::<agama_network::model::BondOptions>()
            .schema_from::<agama_network::model::BridgeConfig>()
            .schema_from::<agama_network::model::BridgePortConfig>()
            .schema_from::<agama_network::model::Connection>()
            .schema_from::<agama_network::model::ConnectionConfig>()
            .schema_from::<agama_network::model::EAPMethod>()
            .schema_from::<agama_network::model::GroupAlgorithm>()
            .schema_from::<agama_network::model::IEEE8021XConfig>()
            .schema_from::<agama_network::model::InfinibandConfig>()
            .schema_from::<agama_network::model::InfinibandTransportMode>()
            .schema_from::<agama_network::model::MatchConfig>()
            .schema_from::<agama_network::model::OvsBridgeConfig>()
            .schema_from::<agama_network::model::OvsBridgePortConfig>()
            .schema_from::<agama_network::model::OvsInterfaceConfig>()
            .schema_from::<agama_network::model::OvsInterfaceType>()
            .schema_from::<agama_network::model::OvsPortConfig>()
            .schema_from::<agama_network::model::PairwiseAlgorithm>()
            .schema_from::<agama_network::model::Phase2AuthMethod>()
            .schema_from::<agama_network::model::PortConfig>()
            .schema_from::<agama_network::model::SecurityProtocol>()
            .schema_from::<agama_network::model::TunConfig>()
            .schema_from::<agama_network::model::TunMode>()
            .schema_from::<agama_network::model::VlanConfig>()
            .schema_from::<agama_network::model::VlanProtocol>()
            .schema_from::<agama_network::model::WEPAuthAlg>()
            .schema_from::<agama_network::model::WEPKeyType>()
            .schema_from::<agama_network::model::WEPSecurity>()
            .schema_from::<agama_network::model::WPAProtocolVersion>()
            .schema_from::<agama_network::model::WirelessBand>()
            .schema_from::<agama_network::model::WirelessConfig>()
            .schema_from::<agama_network::model::WirelessMode>()
            .schema_from::<agama_network::types::BondMode>()
            .schema_from::<agama_network::types::ConnectionState>()
            .schema_from::<agama_network::types::DeviceState>()
            .schema_from::<agama_network::types::DeviceType>()
            ...
            .schema_from::<agama_utils::api::FinishMethod>()
