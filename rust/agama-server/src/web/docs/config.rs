...
impl ApiDocBuilder for ConfigApiDocBuilder {
    ...
    fn components(&self) -> Components {
        ComponentsBuilder::new()
            ...
            .schema_from::<agama_software::model::license::LanguageTag>()
            .schema_from::<agama_software::model::license::License>()
            .schema_from::<agama_software::model::license::LicenseContent>()
            ...
            .schema_from::<agama_utils::api::software::RepositoryParams>()
