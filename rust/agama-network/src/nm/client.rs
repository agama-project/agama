...
/// by other tools may use the UUID. That is the case of the bridges created by dracut, whose
/// ports would otherwise look like plain Ethernet connections and get their controller dropped
/// when Agama writes them back (gh#agama-project/agama#3562).
///
...
mod tests {
    ...
    fn test_resolve_controller_by_uuid() {
        ...
        // A bridge created by dracut refers to its controller by UUID.
        assert_eq!(
