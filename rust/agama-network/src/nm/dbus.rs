...
mod test {
    ...
    use crate::types::{BondMode, DeviceType, SSID};
    use crate::{
        model::*,
        nm::{
            dbus::{
    ...
    fn test_ip_config_emptied_when_disabled() -> anyhow::Result<()> {
        ...
        conn.ip_config.method4 = Ipv4Method::Disabled;
        conn.ip_config.method6 = Ipv6Method::Disabled;
    ...
    fn test_ip_config_kept_when_not_disabled() -> anyhow::Result<()> {
        ...
        conn.ip_config.method6 = Ipv6Method::Auto;
        conn.ip_config.dns_searchlist = vec!["example.com".to_string()];
