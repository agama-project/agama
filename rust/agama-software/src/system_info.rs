...
use crate::{model::{license::License, packages::Repository, pattern::Pattern, product::Product, registration::AddonProperties, ModelAdapter}, service};
use serde::Serialize;
...
impl SystemInfo {
    ...
    pub fn read_from<T: ModelAdapter>(model: &T) -> Result<Self, service::Error> {
