...
The `UILocale` property a single global value shared by all connected clients.
...
1. Check that the text is marked from translation, for a quick verification
...
11. Check the language used by the [service backed](#d-bus-backend)
