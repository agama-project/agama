...
agama.locale({
 ...
 "Confirm Installation": [
  null,
  "Потврдете ја инсталацијата"
 ],
 "If you continue, partitions on your hard disk will be modified according to the provided installation settings.": [
  null,
  "Ако продолжите, партициите на вашиот хард диск ќе бидат изменети според дадените поставки за инсталација."
 ],
 "Please, cancel and check the settings if you are unsure.": [
  null,
  "Ве молиме, откажете ги и проверете ги поставките доколку не сте сигурни."
 ],
 "Continue": [
  null,
  "Продолжи"
 ...
 "TPM sealing requires the new system to be booted directly.": [
  null,
  "Запечатувањето TPM бара новиот систем директно да се бутира."
 ],
 "If a local media was used to run this installer, remove it before the next boot.": [
  null,
  "Ако се користел локален медиум за стартување на овој инсталар, отстранете го пред следното бутирање."
 ],
 "Hide details": [
  null,
  "Сокриј детали"
 ...
 "The installation on your machine is complete.": [
  null,
  "Инсталирањето на вашата машина заврши."
 ],
 "At this point you can power off the machine.": [
  null,
  "Во овој момент можете да ја исклучите машината."
 ],
 "At this point you can reboot the machine to log in to the new system.": [
  null,
  "Во овој момент можете да ја рестартирате машината за да се најавите на новиот систем."
 ],
 "Finish": [
  null,
  "Заврши"
