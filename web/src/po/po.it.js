export default {
  ...
  "Choose how the connection should be associated with a network interface. This helps control which interface the connection uses.": [
    "Scegliere come associare la connessione con un'interfaccia di rete. Ciò aiuta a controllare l'interfaccia utilizzata dalla connessione."
  ],
  "Clear": [
    "Cancella"
  ],
  ...
  "The connection can be used by any available interface.": [
    "La connessione può essere utilizzata da qualsiasi interfaccia disponibile."
  ],
