export default {
  ...
  "If you want to disable this check, please specify \"inst.ay_check=0\" at kernel's command-line": [
    "Bu kontrolü devre dışı bırakmak istiyorsanız, lütfen çekirdeğin komut satırında \"inst.ay_check=0\" ifadesini belirtin"
  ],
  "In progress": [
    "Devam ediyor"
  ],
  ...
  "The product will be registered with \"%s\" hostname": [
    "Ürün, \"%s\" ana bilgisayar adıyla kaydedilecektir"
  ],
