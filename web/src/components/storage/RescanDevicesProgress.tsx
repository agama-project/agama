 ...
 */
function RescanDevicesProgress() {
  useResetProgress();
  useProgressChanges();
  ...
  return (
    ...
    >
      <Spinner size="xl" />
      <Content component="h1">{_("Rescaning devices, this might take a while.")}</Content>
      <Progress steps={steps} step={progress} />
    </Flex>
  );
}

export default RescanDevicesProgress;
