  ...
  volumes: [
    {
      ...
      outline: {
        required: true,
        fsTypes: ["Btrfs", "Ext2", "Ext3", "Ext4", "XFS"],
        ...
        partitions: [
          {
            ...
            systems: [],
            udevIds: [],
            udevPaths: ["pci-0000:09:00.0-part1"],
            isEFI: false,
            component: {
              type: "md_device",
              deviceNames: ["/dev/md0"],
          ...
          },
          {
            ...
            udevIds: [],
            udevPaths: ["pci-0000:09:00.0-part2"],
            isEFI: false,
            component: {
              type: "md_device",
              deviceNames: ["/dev/md0"],
          ...
          },
          {
            ...
            systems: [],
            udevIds: [],
            udevPaths: ["pci-0000:09:00.0-part3"],
            isEFI: false,
            filesystem: {
              sid: 92,
              type: "xfs",
          ...
          },
          {
            ...
            systems: [],
            udevIds: [],
            udevPaths: ["pci-0000:09:00.0-part4"],
            isEFI: false,
          },
        ],
...
export const devices = {
  system: [
        ...
        partitions: [
          {
            ...
            systems: [],
            udevIds: [],
            udevPaths: ["pci-0000:04:00.0-part1"],
            isEFI: false,
          },
          {
            sid: 84,
            ...
            systems: [],
            udevIds: [],
            udevPaths: ["pci-0000:04:00.0-part2"],
            isEFI: false,
            component: {
              type: "physical_volume",
              deviceNames: ["/dev/system"],
            },
          },
        ],
    ...
    },
    {
      ...
      shrinking: { unsupported: ["Resizing is not supported"] },
      systems: [],
      udevIds: ["md-uuid-644aeee1:5f5b946a:4da99758:3f85b3ea"],
      udevPaths: [],
      partitionTable: {
        type: "gpt",
        partitions: [
          {
            ...
            systems: [],
            udevIds: ["md-uuid-644aeee1:5f5b946a:4da99758:3f85b3ea-part1"],
            udevPaths: [],
            isEFI: false,
            filesystem: {
              sid: 93,
      ...
      partitionTable: {
        ...
        partitions: [
          ...
          },
          {
            ...
            systems: [],
            udevIds: [],
            udevPaths: ["pci-0000:09:00.0-part5"],
            isEFI: false,
            filesystem: {
              sid: 464,
              type: "btrfs",
