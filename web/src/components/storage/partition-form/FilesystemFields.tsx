    ...
    return (
      ...
      >
        {({ partitionSource, mountPoint, selectedPartitionId, filesystemAction, filesystem }) => {
            ...
            if (
              ...
              setIncompatibleFsAlert(
                sprintf(
                  ...
                  _(
                    "Selected mount point does not support %s file system type, switched to Automatic",
                  ),
                  previousLabel,
                ),
              );
          ...
          const selectedPartition = device.partitions?.find(
            (p) => p.name === selectedPartitionId,
          );
          ...
          return (
            <Stack hasGutter>
                          ...
                          ? [
                              {
                                ...
                                description: _(
                                  "Do not format, existing data will be preserved",
                                ),
                              },
                            ]
                          : []),
              ...
              {filesystem !== FILESYSTEM_TYPE.AUTO &&
                filesystemAction === FILESYSTEM_ACTION.FORMAT && (
